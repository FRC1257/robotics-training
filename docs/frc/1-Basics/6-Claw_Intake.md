...
Now that you know how to make a subsystem and its supporting files we are going over how to make other subsystems with different features and purposes. The next few lessons will be learning about each of the major subsystems that 1257 uses, why they are important, and how we can program them.

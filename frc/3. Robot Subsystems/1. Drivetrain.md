...
The main thing to take away from this drivetrain is that unlike a car, the wheels cannot rotate left or right. Instead, they are fixed in place and can only spin forward or backwards. Although it restricts our movement, it is much easier to build and program.
...
TO DO later, also reminder to put analog inputs in Controllers.md

...
After creating the `XboxController` object, we put a series of if statements to control our solenoids' actions. The inputs differ for single/double solenoids, however. 
